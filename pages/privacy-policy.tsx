  ...
  return (
    ...
    >
      <Section id="privacy-policy" bg="lightBlue">
        ...
        >
          <Text as="h1" color="black">Privacy Policy di andrealosavio.com</Text>
          <Text color="black">Questo Sito Web raccoglie alcuni Dati Personali dei propri Utenti</Text>
          ...
          <Text as="h2" color="black">Tipologie di Dati Raccolti</Text>
          <Text color="black">
          ...
          <Text as="h2" color="black">Modalità e luogo del trattamento dei Dati raccolti</Text>

          <Text as="h3" color="black">Modalità di trattamento</Text>
          <Text color="black">
          ...
          <Text as="h3" color="black">Base giuridica del trattamento</Text>
          <Text color="black">Il Titolare tratta Dati Personali relativi all’Utente in caso sussista una delle seguenti condizioni:</Text>
          <ul>
            <li>
          ...
          <Text as="h3" color="black">Luogo</Text>
          <Text color="black">
          ...
          <Text as="h3" color="black">Periodo di conservazione</Text>
          <Text color="black">I Dati sono trattati e conservati per il tempo richiesto dalle finalità per le quali sono stati raccolti.</Text>
          ...
          <Text as="h2" color="black">Finalità del Trattamento dei Dati raccolti</Text>
          <Text color="black">
          ...
          <Text as="h2" color="black">Diritti dell'Utente</Text>
          <Text color="black">Gli Utenti possono esercitare determinati diritti con riferimento ai Dati trattati dal Titolare.</Text>
          ...
          <Text as="h3" color="black">Dettagli sul diritto di opposizione</Text>
          <Text color="black">
          ...
          <Text as="h3" color="black">Come esercitare i diritti</Text>
          <Text color="black">
          ...
          <Text as="h2" color="black">Cookie Policy</Text>
          <Text color="black">
            ...
            <Link target="_blank" href="/cookie-policy">Cookie Policy</Link>.
          </Text>

          <Text as="h2" color="black">Ulteriori informazioni sul trattamento</Text>

          <Text as="h3" color="black">Difesa in giudizio</Text>
          <Text color="black">
          ...
          <Text as="h3" color="black">Informative specifiche</Text>
          <Text color="black">
          ...
          <Text as="h3" color="black">Log di sistema e manutenzione</Text>
          <Text color="black">
          ...
          <Text as="h3" color="black">Informazioni non contenute in questa policy</Text>
          <Text color="black">Ulteriori informazioni in relazione al trattamento dei Dati Personali potranno essere richieste in qualsiasi momento al Titolare del Trattamento utilizzando gli estremi di contatto.</Text>

          <Text as="h3" color="black">Risposta alle richieste “Do Not Track”</Text>
          <Text color="black">
          ...
          <Text as="h3" color="black">Modifiche a questa privacy policy</Text>
          <Text color="black">
          ...
          <Text color="black">Qualora le modifiche interessino trattamenti la cui base giuridica è il consenso, il Titolare provvederà a raccogliere nuovamente il consenso dell’Utente, se necessario.</Text>
