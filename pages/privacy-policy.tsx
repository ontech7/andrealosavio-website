      ...
      <Section id="privacy-policy" bg="lightBlue">
        ...
        >
          <Text as="h1" color="black">
            Privacy Policy di andrealosavio.com
          </Text>
          <Text color="black">
          ...
          <Text color="black">
            <b>Andrea Losavio</b> - Milano, Italia
          </Text>
          <Text color="black">
            <b>Indirizzo email del Titolare</b>: losavio.business96@gmail.com
          </Text>
          ...
          <Text color="black">
            ...
            diversamente specificato, tutti i Dati richiesti da questo Sito Web
            ...
            ciò abbia alcuna conseguenza sulla disponibilità del Servizio o
            sulla sua operatività. Gli Utenti che dovessero avere dubbi su quali
            Dati siano obbligatori, sono incoraggiati a contattare il Titolare.
          ...
          <Text color="black">
            ...
            questo Sito Web (personale amministrativo, commerciale, marketing,
          ...
          <Text color="black">Pertanto:</Text>
          <ul>
            <li>
          ...
          <Text color="black">
            ...
            Affiliazione commerciale, Commento dei contenuti, Contattare
            l’Utente, Gestione dei pagamenti, Gestione delle richieste di
            supporto e contatto, Gestione contatti e invio di messaggi,
            Interazione con social network e piattaforme esterne, Ottimizzazione
            e distribuzione del traffico, Pubblicità, Remarketing e behavioral
            targeting, Hosting ed infrastruttura backend, Statistica,
            Visualizzazione di contenuti da piattaforme esterne e Interazione
            con le piattaforme di live chat.
          </Text>
          <Text color="black">
          ...
          <Text color="black">
            Vercel Analytics è un software di statistica utilizzato da questo
            Sito Web per analizzare i dati in maniera diretta e senza l’ausilio
            di terzi.
          </Text>
          <Text color="black">
          ...
          <Text color="black">
            HotJar è un servizio di analisi web fornito da HotJar Ltd. HotJar
            utilizza i Dati Personali, raccolti in forma anonima su questo sito,
            allo scopo di tracciare ed esaminare l'utilizzo di questo Sito Web,
            sottoforma di report visuali chiamate "mappe termiche" che
            permettono di visualizzare quanto tempo gli utenti trascorrono su
            quali pagine, il tracciamento del cursore e i suoi click, e così
            via, ai fini di migliorare e ottimizzare l'esperienza utente.
          </Text>
          <Text color="black">
            Dati Personali raccolti: Cookie e Dati di utilizzo.
          </Text>
          ...
          <Text color="black">
            ...
            gestito da Google Inc. che permette a questo Sito Web di integrare
            tali contenuti all’interno delle proprie pagine.
          </Text>
          <Text color="black">
            Dati Personali raccolti: Cookie e Dati di utilizzo.
          </Text>
          <Text color="black">
            ...
            <Link
              target="_blank"
              href="https://policies.google.com/privacy?hl=policies&gl=it"
            >
              Privacy Policy
            </Link>
          </Text>
          ...
          <Text color="black">In particolare, l’Utente ha il diritto di:</Text>
          <ul>
            <li>
          ...
          <Text color="black">
            ...
            Web o dei Servizi connessi da parte dell’Utente. L’Utente dichiara
            di essere consapevole che il Titolare potrebbe essere obbligato a
          ...
          <Text color="black">
            ...
            browser e del sistema operativo utilizzati dal visitatore, le varie
            connotazioni temporali della visita (ad esempio il tempo di
            permanenza su ciascuna pagina) e i dettagli relativi all’itinerario
            seguito all’interno dell’Applicazione, con particolare riferimento
            alla sequenza delle pagine consultate, ai parametri relativi al
          ...
          <Text color="black">
            ...
            riguarda esclusivamente questo Sito Web.
          </Text>

          <Text color="black" ssx={{ fontStyle: "italic", mt: "20px" }}>
