...
export const servicesMap: Service[] = [
  {
    ...
    description: "Progettazione e costruzione di un sito web su misura per il cliente."
  },
  {
    serviceName: "mobile",
    alt: "Creazione app mobile",
    title: "Creazione app mobile",
    description: "Progettazione e costruzione di un'app mobile su misura per il cliente."
  },
  {
    serviceName: "collab",
  ...
  },
  {
    ...
    alt: "Consulenza",
    title: "Consulenza",
    description: "Supporto per l’impostazione di un sito web, esperienza utente e interfaccia grafica."
  },
  {
    serviceName: "design",
    alt: "Progettazione e design",
    title: "Progettazione e design",
    description: "Prototipazione e progettazione del vostro sito web o di quello di un vostro cliente."
  },
  {
    serviceName: "teach",
