    ...
    <>
      ...
      >
        ...
        >
          <SizableBox width={["65%"]} ssx={{ mb: "60px" }}>
            ...
            >
              <Text as="h2" variant="h2_special" ssx={{ mb: "32px" }}>
                Progetto siti web & app, collaboro con Start Up e Aziende del
                settore, faccio consulenza.
              </Text>

              <Text color="black">
                Sono <b>Andrea Losavio</b>, sviluppatore web e consulente
                residente a <b>Milano</b>.<br />
                Laureato in Ingegneria Informatica al{" "}
          ...
          <SizableBox width={["35%"]} ssx={{ position: "relative", zIndex: 0 }}>
            <div
              sx={{
                borderRadius: "100%",
                overflow: "hidden",
