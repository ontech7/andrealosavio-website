...
export default function CollaborationSection() {
  return (
    ...
    >
      ...
      >
        <SectionWrapper ssx={{ justifyContent: "center", py: "40px" }}>
          <SizableBox width={[, , "90%"]} ssx={{ textAlign: "center" }}>
            <Text as="h2" color="white">
              Sei una Start Up in cerca di <KeyPoint>collaborazioni</KeyPoint>?
            </Text>

            <Text>
              Sono sempre aperto ad eventuali lavori e opportunità di
              partnerships.
            </Text>
