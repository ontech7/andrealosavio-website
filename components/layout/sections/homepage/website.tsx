...
export default function WebsiteSection() {
  return (
    <>
      <Section id="website" bg="lightBlue">
        <SectionWrapper direction={[, "column-reverse"]} ssx={{ gap: "40px" }}>
          <SizableBox>
            ...
            <Text color="black">
              Quando un potenziale cliente cercherà il tuo prodotto o servizio
              su Google, se non trova il tuo sito,{" "}
              <b>troverà quello del tuo concorrente</b>, e il tuo business
              potrebbe risentirne.
            </Text>
            ...
            <Text color="black">
              Bisogna prestare attenzione ai{" "}
